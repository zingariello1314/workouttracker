...
const QuestsCalendarView = ({
  ...
  return (
    <div className="space-y-6">
      <Card className="!rounded-2xl !border-2 !border-amber-400/75 !bg-black !shadow-lg !shadow-black/50 !backdrop-blur-none">
        <CardHeader className="!border-amber-500/25">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-black/90 rounded-lg p-4 text-center border border-amber-500/35">
              ...
              <div className="text-xs text-amber-200/55">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="bg-black/90 rounded-lg p-4 flex items-center gap-3 border border-amber-500/35">
