...
export default function AdvancedFilters({ filters, onFiltersChange, activitiesCount }) {
  ...
  return (
    <div className="rounded-xl border-2 border-[#0F4C5C]/70 bg-black p-4 mb-6 shadow-md shadow-black/40">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-teal-100 font-semibold">🔍 Filtres Avancés</h3>
        <button
          onClick={() => setIsOpen(!isOpen)}
          aria-label="Ouvrir/Fermer les filtres avancés"
          aria-expanded={isOpen}
          className="px-3 py-1.5 rounded-lg border border-[#0F5C45]/70 bg-[#0F4C5C]/40 text-teal-100 text-sm hover:bg-[#0F4C5C]/55 focus:outline-none focus:ring-2 focus:ring-[#0F5C45]/50"
        >
      ...
      {isOpen && (
        <div className="space-y-4" role="group" aria-label="Options de filtrage">
          {/* Type d'activité */}
          <div>
            <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-type">
              Type d'activité
            </label>
            <select
              id="filter-type"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-start-date">
                Date début
              </label>
              <input
            ...
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-end-date">
                Date fin
              </label>
              <input
                id="filter-end-date"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-min-distance">
                Distance min (km)
              </label>
              <input
            ...
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-max-distance">
                Distance max (km)
              </label>
              <input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-min-duration">
                Durée min (min)
              </label>
              <input
            ...
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-max-duration">
                Durée max (min)
              </label>
              <input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-min-calories">
                Calories min
              </label>
              <input
            ...
            <div>
              <label className="block text-teal-100/75 text-sm mb-2" htmlFor="filter-max-calories">
                Calories max
              </label>
              <input
          ...
          {/* Actions */}
          <div className="flex gap-2 pt-2 border-t border-[#0F4C5C]/35">
            <button
              onClick={() => {
                onFiltersChange({
                  type: 'all',
              ...
              className="px-4 py-2 rounded-lg border border-[#0F4C5C]/45 text-teal-100/90 text-sm font-medium hover:bg-teal-950/30 focus:outline-none focus:ring-2 focus:ring-[#0F5C45]/50"
              aria-label="Réinitialiser tous les filtres"
            >
              Réinitialiser
            </button>
            <div className="flex-1 text-right text-sky-300/70 text-sm flex items-center justify-end">
