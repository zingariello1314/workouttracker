 ...
 * 
 * ✅ PHASE 4 : Refactoring complet de SettingsTab.jsx (~3807 lignes → ~250 lignes)
 * 
...
import { useAllDataExportImport } from './hooks/useAllDataExportImport';

// Composants
import ProfileSettings from './components/ProfileSettings';
import SwipeNavigationSettings from './components/SwipeNavigationSettings';
import LanguageSettings from './components/LanguageSettings';
import InfoCards from './components/InfoCards';
import DataCleanupSection from './components/DataCleanupSection';
import { BodyTrackingImportPreviewModal, AllDataImportPreviewModal } from './components/ImportPreviewModal';
import QuietQuestExportImport from './components/QuietQuestExportImport';
import BooksExportImport from './components/BooksExportImport';
import BudgetExportImport from './components/BudgetExportImport';
import ApprentissageExportImport from './components/ApprentissageExportImport';
import { ExportSection, ImportSection } from './components/ExportImportSection';
