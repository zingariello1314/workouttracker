...
import { filterActiveQuestions, isRunOrientedProfile } from './quizQuestionVisibility';
...
describe('quizAnswersMigration v12', () => {
  it('infère primaryMission depuis goalPhysique hypertrophie street', () => {
    ...
    expect(out.primaryMission).toBe('hypertrophy_street');
  ...
  it('infère runningGoal pour endurance_lean', () => {
    ...
    expect(out.primaryMission).toBe('run_5k_10k');
