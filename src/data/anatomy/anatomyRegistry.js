...
export const ANATOMY_MUSCLES = {
  'grand-pectoral': {
    ...
    presentationChips: ['Claviculaire', 'Sterno-costal', 'Abdominal'],
  ...
  deltoide: {
    ...
    name: 'Deltoïde',
    summary:
      'Muscle majeur de l’épaule — trois faisceaux aux orientations différentes, participant à l’élévation et au contrôle de l’humérus.',
    presentationChips: ['Antérieur', 'Acromial', 'Postérieur'],
    functionalImportance: 'high',
    aestheticImportance: 'high',
  ...
  'coiffe-rotateurs': {
    ...
    summary:
      'Supra-épineux, infra-épineux, petit rond et subscapulaire — contrôle dynamique de l’épaule.',
    presentationChips: ['Supra-épineux', 'Infra-épineux', 'Petit rond', 'Subscapulaire'],
    functionalImportance: 'high',
    aestheticImportance: 'low',
    visualGroupId: MuscleGroups.SHOULDERS,
    contentReady: true,
  ...
  'grand-dorsal': {
    ...
    familyId: 'haut-dos',
    name: 'Grand dorsal',
    summary: 'Muscle majeur de la chaîne de tirage — adduction, extension et rotation médiale du bras.',
    functionalImportance: 'high',
    aestheticImportance: 'high',
  ...
  'erecteurs-rachis': {
    ...
    summary:
      'Colonnes musculaires paravertébrales — extension du rachis, contrôle de la flexion et maintien de la stabilité du tronc.',
    presentationChips: ['Ilio-costal', 'Longissimus', 'Épineux'],
    functionalImportance: 'high',
    aestheticImportance: 'medium',
    visualGroupId: MuscleGroups.BACK,
    contentReady: true,
  ...
  multifides: {
    ...
    familyId: 'bas-dos',
    name: 'Multifides',
    summary: 'Muscles profonds segmentaires — contrôle fin et stabilisation du rachis.',
    functionalImportance: 'high',
    aestheticImportance: 'low',
    visualGroupId: MuscleGroups.BACK,
    contentReady: true,
  ...
  'biceps-brachial': {
    ...
    summary: 'Deux chefs · deux articulations · flexion, supination et tractions.',
    presentationChips: ['Deux chefs', 'Deux articulations', 'Trois fonctions majeures'],
    functionalImportance: 'high',
    aestheticImportance: 'high',
  ...
  'elevateur-scapula': {
    ...
    summary:
      'Élévation de la scapula — contrôle cervico-scapulaire et stabilité de l’épaule.',
    presentationChips: ['C1–C4', 'Angle supérieur', 'Trapèze supérieur'],
    functionalImportance: 'high',
    aestheticImportance: 'medium',
    visualGroupId: MuscleGroups.SHOULDERS,
    contentReady: true,
