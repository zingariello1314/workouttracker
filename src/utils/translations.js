...
export const translations = {
  [LANGUAGES.FR]: {
    ...
    'rubiks.subTabs.solve': 'Résoudre',
    'rubiks.subTabs.timer': 'Chrono',
    'rubiks.subTabs.methods': 'Méthodes',
    'rubiks.subTabs.settings': 'Paramètres',
    'apprentissage.subTabs.matieres': 'Matières',
    'apprentissage.subTabs.sessions': 'Sessions',
    'apprentissage.subTabs.trophees': 'Trophées',
    'apprentissage.subTabs.calendrier': 'Calendrier',
    'apprentissage.subTabs.rubiks': "Rubik's cube",
    'nav.books': 'Livres',
    'nav.knowledge': 'TikTop',

    // TikTop (vidéos)
    'knowledge.title': 'TikTop',
    'knowledge.subtitle': 'Vidéos stockées localement sur cet appareil (IndexedDB).',
    'knowledge.breadcrumb': 'TikTop',
    'knowledge.adminBadge': 'Édition',
    'knowledge.readOnlyBadge': 'Lecture seule',
    'knowledge.navLabel': 'Sections',
    'knowledge.views.videos': 'Vidéos',
    'knowledge.views.articles': 'Articles',
    'knowledge.views.notes': 'Notes',
    'knowledge.authRequiredTitle': 'Connexion requise',
    'knowledge.authRequiredHint': 'Connecte-toi pour consulter TikTop.',
    'knowledge.allCategories': 'Tout',
    'knowledge.searchVideos': 'Rechercher une vidéo…',
    'knowledge.searchArticles': 'Rechercher un article…',
    'knowledge.searchNotes': 'Rechercher une note…',
    'knowledge.uploadVideo': 'Ajouter une vidéo',
    'knowledge.videoTitle': 'Titre de la vidéo',
    'knowledge.pickCategories': 'Catégories',
    'knowledge.newCategory': 'Nouvelle catégorie',
    'knowledge.upload': 'Publier',
    'knowledge.uploading': 'Envoi…',
    'knowledge.r2NotConfigured': 'Stockage vidéo cloud non configuré (option future).',
    'knowledge.storageUnavailable': 'IndexedDB indisponible sur ce navigateur.',
    'knowledge.emptyVideos': 'Aucune vidéo pour le moment.',
    'knowledge.delete': 'Supprimer',
    'knowledge.confirmDeleteVideo': 'Supprimer « {{title}} » ?',
    'knowledge.confirmDelete': 'Supprimer cet élément ?',
    'knowledge.hideCategories': 'Masquer des catégories (filtre personnel)',
    'knowledge.newArticle': 'Nouvel article',
    'knowledge.articleTitle': 'Titre',
    'knowledge.articleUrl': 'Lien vers l’article (optionnel)',
    'knowledge.articleBody': 'Contenu',
    'knowledge.openSource': 'Ouvrir la source',
    'knowledge.newNote': 'Nouvelle note',
    'knowledge.noteTitle': 'Titre',
    'knowledge.noteSources': 'Liens sources (un par ligne)',
    'knowledge.noteBody': 'Synthèse / notes',
    'knowledge.close': 'Fermer',
    'knowledge.save': 'Enregistrer',
    'knowledge.sectionNav': 'Navigation des sections',
    'knowledge.sections.feed': 'Feed',
    'knowledge.sections.library': 'Bibliothèque',
    'knowledge.sections.categories': 'Catégories',
    'knowledge.storageStats': '{{videos}} vidéo(s) · {{size}}',
    'knowledge.storagePersistent': 'Persistant sur cet appareil',
    'knowledge.recentlyWatched': 'Récemment regardées',
    'knowledge.emptyLibrary': 'Aucun contenu dans la bibliothèque.',
    'knowledge.emptyVideosHint': 'Ajoute une vidéo (admin) — elle restera après rafraîchissement.',
    'knowledge.emptyArticles': 'Aucun article pour le moment.',
    'knowledge.emptyArticlesHint': 'Crée un article (admin) — stocké localement.',
    'knowledge.emptyNotes': 'Aucune note pour le moment.',
    'knowledge.emptyNotesHint': 'Crée une note (admin) — stockée localement.',
    'knowledge.uncategorized': 'Sans catégorie',
    'knowledge.emptyCategories': 'Aucune catégorie.',
    'knowledge.emptyCategoriesHint': 'Crée une catégorie pour organiser ton contenu.',
    'knowledge.addCategory': 'Ajouter',
    'knowledge.confirmDeleteCategory': 'Supprimer la catégorie « {{name}} » ?',
    'knowledge.categoryItemCount': '{{count}} élément(s)',
    'knowledge.hideCategory': 'Masquer',
    'knowledge.showCategory': 'Afficher',
    'knowledge.uploadHint': 'Fichier stocké dans IndexedDB — persiste après redémarrage.',
    'knowledge.pickVideoFile': 'Choisir un fichier vidéo (MP4, WebM…)',
    'knowledge.pickVideoFiles': 'Choisir une ou plusieurs vidéos (MP4, WebM…)',
    'knowledge.pickVideoFilesHint': 'Sélection multiple possible — Ctrl+clic ou Shift+clic dans l’explorateur.',
    'knowledge.uploadQueueCount': '{{count}} vidéo(s) en attente',
    'knowledge.uploadQueueEmpty': 'Aucune vidéo sélectionnée — choisis des fichiers ci-dessus.',
    'knowledge.uploadQueueSelected': '{{count}} vidéo(s) sélectionnée(s)',
    'knowledge.selectAll': 'Tout sélectionner',
    'knowledge.deselectAll': 'Tout désélectionner',
    'knowledge.removeFromQueue': 'Retirer de la liste',
    'knowledge.applyCategoriesHint': 'Clique une catégorie pour l’ajouter ou la retirer sur la sélection.',
    'knowledge.pickCategoriesDefaultHint': 'Catégories appliquées aux nouvelles vidéos ajoutées. Sélectionne des vidéos pour modifier plusieurs à la fois.',
    'knowledge.publishCount': 'Publier {{count}} vidéos',
    'knowledge.uploadProgress': 'Envoi {{current}}/{{total}}…',
    'knowledge.fullscreen': 'Plein écran',
    'knowledge.exitFullscreen': 'Quitter le plein écran',
    'knowledge.mute': 'Couper le son',
    'knowledge.unmute': 'Activer le son',
    'knowledge.librarySortLabel': 'Trier par',
    'knowledge.librarySortNewest': 'Plus récentes',
    'knowledge.librarySortOldest': 'Plus anciennes',
    'knowledge.editCategories': 'Catégories',
    'knowledge.savingCategories': 'Enregistrement…',
    'knowledge.pickCategoriesHint': 'Sélectionne une catégorie (ou crée-en une ci-dessous — elle sera liée à la vidéo).',
    'knowledge.noCategoriesYet': 'Aucune catégorie — crée-en une ci-dessous.',
    'knowledge.uploadFailed': 'Échec de l’envoi. Réessaie ou choisis un fichier plus petit.',
    'knowledge.shortsFeed': 'Feed vidéos vertical',
    'knowledge.shortsScrollHint': 'Scroll pour la suite',
    'knowledge.feedFilterTitle': 'Filtrer le feed',
    'knowledge.feedFilterHint': 'Clic : inclure uniquement → exclure → tout',
    'knowledge.feedFilterCycle': 'Changer le filtre de cette catégorie',
    'knowledge.feedFilterReset': 'Réinitialiser',
    'knowledge.feedFilterIncludeCount': '{{count}} catégorie(s) incluse(s)',
    'knowledge.feedFilterExcludeCount': '{{count}} exclue(s)',
    'knowledge.feedFilterAllCategories': 'Toutes les catégories',
    'knowledge.emptyVideosFiltered': 'Aucune vidéo pour ce filtre.',
    'knowledge.emptyVideosFilteredHint': 'Inclus d’autres catégories ou réinitialise les filtres.',
    'nav.code': 'Code',
    ...
    'anatomy.modelHint': 'Clique un muscle sur le modèle ou fais pivoter / zoomer comme dans le Récap.',
    'anatomy.familiesTitle': 'Familles musculaires',
    'anatomy.muscleCount': 'muscles',
    'anatomy.fichesReady': 'fiche(s) complète(s)',
    'anatomy.backHome': 'Accueil Anatomie',
    'anatomy.hitMuscle': 'Muscle',
    'anatomy.hitFamily': 'Famille',
    'anatomy.hitExercise': 'Exercice',
    'anatomy.func': 'Fonction',
    'anatomy.aesthetic': 'Esthétique',
    'anatomy.fullSheet': 'Fiche complète',
    'anatomy.contentSoon': 'Contenu détaillé en cours de rédaction.',
    'anatomy.linkedExercises': 'Exercices dans Momentum',
    'anatomy.muscleNotFound': 'Muscle introuvable.',
    'anatomy.momentumLink': 'Lien avec ton entraînement (7 jours)',
    'anatomy.momentumShare':
      'Reps force sur la zone Récap liée (7 j) : ~{{pct}} — période {{start}} → {{end}}.',
    'anatomy.repsShare': 'parts de reps',
    'anatomy.noRecentVolume': 'Peu ou pas de volume récent sur cette zone.',
    'anatomy.openRecap': 'Ouvrir le Récap corps →',
    'anatomy.backShort': 'Retour',
    'anatomy.hoverPrompt': 'Passe la souris sur une zone du corps',
    'anatomy.clickToOpen': 'cliquer pour ouvrir',
    'anatomy.momentumShareShort': 'Reps force (zone Récap) · {{start}} → {{end}}',
    'anatomy.endurancePushupsLabel': 'Pompes (onglet Endurance)',
    'anatomy.syntheticExercise': 'Volume agrégé',
    'anatomy.familyContext': 'Famille {{name}}',
    ...
    'anatomy.familyMusclesTitle': 'Muscles de cette famille',
    'anatomy.funcShort': 'Fonctionnel',
    'anatomy.aestheticShort': 'Esthétique',
    'anatomy.sheetLabel': 'Fiche muscle',
    'anatomy.inYourProgram': 'Dans ton programme',
    'anatomy.weeklyVolume': 'Volume hebdo',
    'anatomy.repsShareShort': 'parts reps',
    'anatomy.status': 'Statut',
    'anatomy.statusWellTrained': 'Bien entraîné',
    'anatomy.statusModerate': 'Volume modéré',
    'anatomy.statusLow': 'Peu sollicité',
    'anatomy.sessionExercises': 'Exercices de ta séance',
    'anatomy.relatedMuscles': 'Muscles liés',
    'anatomy.location': 'Localisation',
    'anatomy.modelPickHint':
      'Survole une zone (elle s’illumine) · clique pour ouvrir la fiche · glisser pour tourner · molette pour zoomer.',
    'anatomy.modelPickHintShort': 'Survol · clic · glisser · molette',
    ...
    'recap.exerciseGrades.introShort':
      'Grades par exercice (Bois → Platine) : pic de série, volume journalier et régularité, ajustés à ton profil.',
    'recap.exerciseGrades.loading': 'Calcul des grades exercices…',
    'recap.exerciseGrades.listTitle': 'Classement',
    'recap.exerciseGrades.withData': 'exercices suivis',
    'recap.exerciseGrades.updating': 'mise à jour…',
    'recap.exerciseGrades.sort': 'Trier',
    'recap.exerciseGrades.sortGrade': 'Meilleur → pire grade',
    'recap.exerciseGrades.sortReps': 'Plus → moins de reps',
    'recap.exerciseGrades.sortMuscle': 'Groupe musculaire',
    'recap.exerciseGrades.sortAlpha': 'Alphabétique',
    'recap.exerciseGrades.levelShort': 'Niv. {{n}}',
    'recap.exerciseGrades.checkedShort': 'coché',
    'recap.exerciseGrades.nextGrade': 'Prochain : {{grade}}',
    'recap.exerciseGrades.parallelLevel': 'Niveau {{n}}',
    'recap.exerciseGrades.repEqShort': 'rep eq.',
    'recap.exerciseGrades.parallelRepEq': 'Rep eq. (niveau)',
    'recap.exerciseGrades.levelGate': 'Niveau requis (grade)',
    'recap.exerciseGrades.voieE': 'Voie E — équilibre {{pct}} %',
    ...
    'recap.exerciseGrades.voieEHint':
      'Atteindre ≥ {{pct}} % sur pic, volume et coches (voie polyvalence)',
    'recap.exerciseGrades.voieEPathsFull': 'Voies complètes : {{n}} / {{required}}',
    'recap.exerciseGrades.detailMissing': 'Exercice introuvable.',
    'recap.exerciseGrades.backToList': 'Retour au classement',
    'recap.exerciseGrades.detailTitle': 'Fiche exercice',
    'recap.exerciseGrades.activitySpan': 'Du {{from}} au {{to}}',
    'recap.exerciseGrades.parallelLevelLine': 'Niveau {{n}} · {{eq}} rep équivalent pompes (×{{w}})',
    'recap.exerciseGrades.gradePaths': 'Voies actives : {{paths}}',
    'recap.exerciseGrades.levelEvolutionTitle': 'Évolution du niveau',
    'recap.exerciseGrades.levelEvolutionLine': 'Niveau {{cur}} → {{next}} · {{eq}} rep eq.',
    'recap.exerciseGrades.levelRepEqNeeded': 'Encore {{n}} rep eq. pour le niveau {{next}}',
    'recap.exerciseGrades.nextGradeTargets': 'Prochain palier {{grade}} : pic {{peak}} · vol. {{life}} · {{checks}} coches',
    'recap.exerciseGrades.performanceMaxTitle': 'Max Performances (défis)',
    'recap.exerciseGrades.secondsShort': 's',
    'recap.exerciseGrades.repsShort': 'reps',
    'recap.exerciseGrades.performanceMaxHint': 'Synchronisé avec l’onglet Performances / défis',
    'recap.exerciseGrades.pushupSplitTitle': 'Répartition pompes (total)',
    'recap.exerciseGrades.recordsTitle': 'Records personnels',
    'recap.exerciseGrades.recordTop': 'Record',
    'recap.exerciseGrades.statBestDay': 'Meilleur jour',
    'recap.exerciseGrades.statBestWeek': 'Meilleure semaine',
    'recap.exerciseGrades.weekTotalHint': 'Total sur 7 jours (lun. → dim.)',
    'recap.exerciseGrades.statBestMonth': 'Meilleur mois',
    'recap.exerciseGrades.monthTotalHint': 'Total sur le mois calendaire',
    'recap.exerciseGrades.statChecks': 'Séances cochées',
    'recap.exerciseGrades.statChecksSub': 'Programme + défis liés',
    'recap.exerciseGrades.statAvgDay': 'Moyenne / jour actif',
    'recap.exerciseGrades.statAvgDaySub': '{{n}} jours avec activité',
    'recap.exerciseGrades.statYear': 'En {{year}}',
    'recap.exerciseGrades.statYearChecks': '{{n}} coches',
    'recap.exerciseGrades.statRegularity': 'Régularité (jours prévus)',
    'recap.exerciseGrades.statRegularitySub': '{{ok}} / {{total}} jours planifiés cochés',
    'recap.exerciseGrades.statRegularityNa': 'Programme actif requis pour ce calcul',
    'recap.exerciseGrades.statLifetime': 'Volume total',
    'recap.exerciseGrades.checkHistoryTitle': 'Historique des coches',
    'recap.exerciseGrades.checkHistoryHint':
      'Chaque ligne = une séance cochée ou un défi enregistré. Supprimer une coche recalcule le grade.',
    'recap.exerciseGrades.openCheckInCalendar': 'Voir cette coche dans le calendrier',
    'recap.exerciseGrades.openInCalendarShort': 'Calendrier',
    'recap.exerciseGrades.badgeBestDay': 'Meilleur jour',
    'recap.exerciseGrades.badgePeakSession': 'Meilleure séance',
    'recap.exerciseGrades.sourceEndurance': 'Défis pompes',
    'recap.exerciseGrades.deleteCheck': 'Supprimer cette coche',
    'recap.exerciseGrades.deleteCheckTitle': 'Supprimer cette coche ?',
    'recap.exerciseGrades.deleteCheckBody':
      'Cette action retire la séance de l’historique grades. Le grade peut baisser ; les trophées déjà obtenus restent mémorisés.',
    'recap.exerciseGrades.deleteCheckConfirm': 'Supprimer',
    'recap.exerciseGrades.timelineTitle': 'Historique des grades',
    'recap.exerciseGrades.timelineNoDate': 'Date non enregistrée (niveau déjà atteint)',
    'recap.exerciseGrades.vitalsTitle': 'Profil physique',
    'recap.exerciseGrades.vitalsIntro':
      'Poids, taille et âge ajustent les seuils. Priorité : saisie locale, impédance, questionnaire profil.',
    'recap.exerciseGrades.vitalsSource': 'Source actuelle : {{source}}',
    'recap.exerciseGrades.vitalsSex': 'Sexe',
    'recap.exerciseGrades.vitalsSexMissing':
      'Sexe : questionnaire profil (homme par défaut pour les seuils pompes)',
    'recap.exerciseGrades.vitalsDefaults': 'complète les champs pour un calcul précis',
    'recap.exerciseGrades.weight': 'Poids (kg)',
    'recap.exerciseGrades.height': 'Taille (cm)',
    'recap.exerciseGrades.age': 'Âge',
    'recap.exerciseGrades.vitalsSave': 'Enregistrer pour les grades',
    'recap.exerciseGrades.ladderGalleryTitle': 'Parcours des grades exercice',
    'recap.exerciseGrades.ladderGalleryIntro':
      'Chaque matériau comporte trois paliers. Clique pour le détail et tes exercices par palier.',
    'recap.exerciseGrades.ladderPalierShort': 'Palier {{n}}',
    'recap.exerciseGrades.ladderTierReached': 'Palier atteint : {{label}}',
    'recap.exerciseGrades.ladderDetailBack': 'Retour au parcours des grades exercice',
    'recap.exerciseGrades.ladderDetailStatus': 'Grades par exercice',
    'recap.exerciseGrades.ladderDetailHint':
      'Seuils indicatifs par palier — ton profil (âge, sexe, poids) peut les ajuster.',
    'recap.exerciseGrades.ladderDetailTiersTitle': 'Paliers (seuils indicatifs)',
    'recap.exerciseGrades.ladderGateShort': 'pic {{p}} · vol. {{v}} · {{c}} coches',
    'recap.exerciseGrades.ladderRecapTitle': 'Récap — tes exercices par palier',
    'recap.exerciseGrades.ladderRecapHint': 'Exercices où tu as atteint au moins ce palier sur la fiche.',
    'recap.exerciseGrades.checksShort': 'coches',
    'recap.exerciseGrades.ladderNoExercisesPalier': 'Aucun exercice à ce palier pour l’instant.',
    'sport.exerciseGrade.progressPeak': 'Pic / max série',
    'sport.exerciseGrade.progressLife': 'Volume',
    'sport.exerciseGrade.progressChecks': 'Séances cochées',
    ...
    'recap.assessment.horizonShort': 'Maintenant · ce qui vient de se passer',
    'recap.assessment.horizonMedium': 'Trajectoire · ce qui se construit',
    'recap.assessment.horizonLong': 'Parcours · depuis tes débuts',
    ...
    'recap.analyse.cardioLineKm': '{{km}} km · {{n}} sortie(s) fusionnées.',
    'recap.analyse.cardioLineJump': 'Corde : {{n}} sauts sur la période.',
    'recap.analyse.calJustified': '{{n}} jour(s) justifié(s) sur la période.',
    'recap.analyse.calFullDays': '{{n}} jour(s) à 100 % complétion.',
    'recap.analyse.calChallenge': 'Défi actif : {{title}}.',
    'recap.analyse.kpiRunning': 'Course (période)',
    'recap.analyse.kpiStreak': 'Série entraînement',
    'recap.analyse.kpiStreakBest': 'Record {{n}} j',
    'recap.analyse.kpiChallenges': 'Défis actifs',
    'recap.analyse.kpiGtg': 'GTG',
    'recap.analyse.kpiActiveKcal': 'Kcal actives',
    'recap.analyse.alerts': 'Points d’attention',
    'recap.analyse.quizIncomplete':
      'Questionnaire profil incomplet — complète-le pour affiner les conseils.',
    'recap.analyse.pillarCardio': 'Cardio & défis',
    'recap.analyse.pillarCalendar': 'Calendrier & défis',
    'recap.analyse.noCardioData': 'Peu de cardio enregistré sur cette période.',
    'recap.analyse.noCalendarData': 'Coche des séances pour alimenter le calendrier.',
    'recap.analyse.periodHighlights.title': 'Récap sur la période',
    'recap.analyse.periodHighlights.empty': 'Pas assez de données sur cette période.',
    'recap.analyse.noWeight': 'Ajoute une pesée (Suivi corporel) pour ancrer la tendance de poids.',
    'recap.benchmark.title': 'Repères & comparaisons',
    ...
    'recap.programCoach.signalsExtra': 'Signaux programme détaillés',
    'recap.enrichment.pushPull': 'Push / Pull (reps)',
    'recap.enrichment.adherenceItems': 'Adhérence items',
    'recap.enrichment.weightDelta': 'Évolution poids',
    'recap.enrichment.weightLatest': 'Dernière : {{v}} kg',
    'recap.enrichment.dowAdherence': 'Complétion par jour de semaine',
    'recap.enrichment.muscleShare': 'Répartition musculaire (reps)',
    'recap.enrichment.feedbackAggregate': 'Feedbacks séance (moyennes)',
    'recap.enrichment.feedbackCount': '{{n}} séances renseignées',
    'recap.enrichment.feedback.ressenti': 'Ressenti',
    'recap.enrichment.feedback.difficulte': 'Difficulté',
    'recap.enrichment.feedback.motivation': 'Motivation',
    'recap.enrichment.feedback.sommeil': 'Sommeil (feedback)',

    'recap.programCoach.title': 'Analyse du programme',
    'recap.programCoach.vision': 'Vision coach',
    'recap.programCoach.musclePlan': 'Répartition musculaire (plan hebdo)',
    'recap.programCoach.pushPullRatio': 'Ratio push/pull planifié : {{ratio}}',
    'recap.programCoach.levelStructural': 'Structure & équilibre',
    'recap.programCoach.levelProgression': 'Progression réelle',
    'recap.programCoach.levelRecovery': 'Récupération',
    'recap.programCoach.levelTrends': 'Tendances détectées',
    'recap.programCoach.levelCompliments': 'Points positifs',
    'recap.programCoach.levelRecommendations': 'Recommandations',
    'recap.programCoach.noProgram': 'Active un programme pour cette analyse.',
    'recap.programCoach.noProgression': 'Coche tes séances pour comparer prévu vs réalisé.',
    'recap.programCoach.noRecovery': 'Connecte Garmin ou saisis feedback pour enrichir.',
    'recap.programCoach.noTrends': 'Pas assez de données croisées sur la période.',
    'recap.programCoach.noCompliments': 'Continue à t’entraîner — les compliments viendront avec la régularité.',
    'recap.programCoach.noRecommendations': 'Programme déjà bien calibré sur les données actuelles.',
  ...
  [LANGUAGES.EN]: {
    ...
    'nav.rubiks': "Rubik's cube",
    'rubiks.subTabs.solve': 'Solve',
    'rubiks.subTabs.timer': 'Timer',
    'rubiks.subTabs.methods': 'Methods',
    'rubiks.subTabs.settings': 'Settings',
    'apprentissage.subTabs.matieres': 'Subjects',
    'apprentissage.subTabs.sessions': 'Sessions',
    'apprentissage.subTabs.trophees': 'Trophies',
    'apprentissage.subTabs.calendrier': 'Calendar',
    'apprentissage.subTabs.rubiks': "Rubik's cube",
    'nav.books': 'Books',
    'nav.knowledge': 'TikTop',

    'knowledge.title': 'TikTop',
    'knowledge.subtitle': 'Videos stored locally on this device (IndexedDB).',
    'knowledge.breadcrumb': 'TikTop',
    'knowledge.adminBadge': 'Editor',
    'knowledge.readOnlyBadge': 'Read only',
    'knowledge.navLabel': 'Sections',
    'knowledge.views.videos': 'Videos',
    'knowledge.views.articles': 'Articles',
    'knowledge.views.notes': 'Notes',
    'knowledge.authRequiredTitle': 'Sign in required',
    'knowledge.authRequiredHint': 'Sign in to browse TikTop.',
    'knowledge.allCategories': 'All',
    'knowledge.searchVideos': 'Search videos…',
    'knowledge.searchArticles': 'Search articles…',
    'knowledge.searchNotes': 'Search notes…',
    'knowledge.uploadVideo': 'Add video',
    'knowledge.videoTitle': 'Video title',
    'knowledge.pickCategories': 'Categories',
    'knowledge.newCategory': 'New category',
    'knowledge.upload': 'Publish',
    'knowledge.uploading': 'Uploading…',
    'knowledge.r2NotConfigured': 'Cloud video storage not configured (future option).',
    'knowledge.storageUnavailable': 'IndexedDB is unavailable in this browser.',
    'knowledge.emptyVideos': 'No videos yet.',
    'knowledge.delete': 'Delete',
    'knowledge.confirmDeleteVideo': 'Delete « {{title}} »?',
    'knowledge.confirmDelete': 'Delete this item?',
    'knowledge.hideCategories': 'Hide categories (personal filter)',
    'knowledge.newArticle': 'New article',
    'knowledge.articleTitle': 'Title',
    'knowledge.articleUrl': 'Link to article (optional)',
    'knowledge.articleBody': 'Content',
    'knowledge.openSource': 'Open source',
    'knowledge.newNote': 'New note',
    'knowledge.noteTitle': 'Title',
    'knowledge.noteSources': 'Source links (one per line)',
    'knowledge.noteBody': 'Summary / notes',
    'knowledge.close': 'Close',
    'knowledge.save': 'Save',
    'knowledge.sectionNav': 'Section navigation',
    'knowledge.sections.feed': 'Feed',
    'knowledge.sections.library': 'Library',
    'knowledge.sections.categories': 'Categories',
    'knowledge.storageStats': '{{videos}} video(s) · {{size}}',
    'knowledge.storagePersistent': 'Persistent on this device',
    'knowledge.recentlyWatched': 'Recently watched',
    'knowledge.emptyLibrary': 'No content in the library.',
    'knowledge.emptyVideosHint': 'Add a video (admin) — it persists after refresh.',
    'knowledge.emptyArticles': 'No articles yet.',
    'knowledge.emptyArticlesHint': 'Create an article (admin) — stored locally.',
    'knowledge.emptyNotes': 'No notes yet.',
    'knowledge.emptyNotesHint': 'Create a note (admin) — stored locally.',
    'knowledge.uncategorized': 'Uncategorized',
    'knowledge.emptyCategories': 'No categories.',
    'knowledge.emptyCategoriesHint': 'Create a category to organize your content.',
    'knowledge.addCategory': 'Add',
    'knowledge.confirmDeleteCategory': 'Delete category « {{name}} »?',
    'knowledge.categoryItemCount': '{{count}} item(s)',
    'knowledge.hideCategory': 'Hide',
    'knowledge.showCategory': 'Show',
    'knowledge.uploadHint': 'File stored in IndexedDB — persists after restart.',
    'knowledge.pickVideoFile': 'Choose a video file (MP4, WebM…)',
    'knowledge.pickVideoFiles': 'Choose one or more videos (MP4, WebM…)',
    'knowledge.pickVideoFilesHint': 'Multi-select in the file picker — Ctrl+click or Shift+click.',
    'knowledge.uploadQueueCount': '{{count}} video(s) queued',
    'knowledge.uploadQueueEmpty': 'No videos selected — pick files above.',
    'knowledge.uploadQueueSelected': '{{count}} video(s) selected',
    'knowledge.selectAll': 'Select all',
    'knowledge.deselectAll': 'Deselect all',
    'knowledge.removeFromQueue': 'Remove from list',
    'knowledge.applyCategoriesHint': 'Click a category to add or remove it on the selection.',
    'knowledge.pickCategoriesDefaultHint': 'Default categories for newly added videos. Select videos to edit several at once.',
    'knowledge.publishCount': 'Publish {{count}} videos',
    'knowledge.uploadProgress': 'Uploading {{current}}/{{total}}…',
    'knowledge.fullscreen': 'Fullscreen',
    'knowledge.exitFullscreen': 'Exit fullscreen',
    'knowledge.mute': 'Mute',
    'knowledge.unmute': 'Unmute',
    'knowledge.librarySortLabel': 'Sort by',
    'knowledge.librarySortNewest': 'Newest first',
    'knowledge.librarySortOldest': 'Oldest first',
    'knowledge.editCategories': 'Categories',
    'knowledge.savingCategories': 'Saving…',
    'knowledge.pickCategoriesHint': 'Select a category (or create one below — it will be linked to the video).',
    'knowledge.noCategoriesYet': 'No categories — create one below.',
    'knowledge.uploadFailed': 'Upload failed. Try again or use a smaller file.',
    'knowledge.shortsFeed': 'Vertical video feed',
    'knowledge.shortsScrollHint': 'Scroll for more',
    'knowledge.feedFilterTitle': 'Filter feed',
    'knowledge.feedFilterHint': 'Click: include only → exclude → all',
    'knowledge.feedFilterCycle': 'Change filter for this category',
    'knowledge.feedFilterReset': 'Reset',
    'knowledge.feedFilterIncludeCount': '{{count}} category(ies) included',
    'knowledge.feedFilterExcludeCount': '{{count}} excluded',
    'knowledge.feedFilterAllCategories': 'All categories',
    'knowledge.emptyVideosFiltered': 'No videos for this filter.',
    'knowledge.emptyVideosFilteredHint': 'Include other categories or reset filters.',
    'nav.code': 'Code',
    ...
    'anatomy.subtitle': 'Interactive sports anatomy — muscles, biomechanics, and Momentum exercises.',
    'anatomy.searchPlaceholder': 'Muscle, exercise, goal (e.g. upper chest, bench press…)',
    'anatomy.modelHint': 'Click a muscle on the model or rotate / zoom like in Recap.',
    'anatomy.familiesTitle': 'Muscle families',
    'anatomy.muscleCount': 'muscles',
    'anatomy.fichesReady': 'full sheet(s)',
    'anatomy.backHome': 'Anatomy home',
    'anatomy.hitMuscle': 'Muscle',
    'anatomy.hitFamily': 'Family',
    'anatomy.hitExercise': 'Exercise',
    'anatomy.func': 'Function',
    'anatomy.aesthetic': 'Aesthetic',
    'anatomy.fullSheet': 'Full sheet',
    'anatomy.contentSoon': 'Detailed content coming soon.',
    'anatomy.linkedExercises': 'Exercises in Momentum',
    'anatomy.muscleNotFound': 'Muscle not found.',
    'anatomy.momentumLink': 'Your training (7 days)',
    'anatomy.momentumShare': 'Strength reps on linked Recap zone (7d): ~{{pct}} — {{start}} → {{end}}.',
    'anatomy.repsShare': 'rep share',
    'anatomy.noRecentVolume': 'Little or no recent volume on this zone.',
    'anatomy.openRecap': 'Open body Recap →',
    'anatomy.backShort': 'Back',
    'anatomy.hoverPrompt': 'Hover a body area',
    'anatomy.clickToOpen': 'click to open',
    'anatomy.momentumShareShort': 'Strength reps (Recap zone) · {{start}} → {{end}}',
    'anatomy.endurancePushupsLabel': 'Push-ups (Endurance tab)',
    'anatomy.syntheticExercise': 'Aggregated volume',
    'anatomy.familyContext': 'Family {{name}}',
    'anatomy.modelPickHint':
      'Hover to highlight · click to open the sheet · drag to rotate · scroll to zoom.',
    'anatomy.modelPickHintShort': 'Hover · click · drag · scroll',
    ...
    'recap.exerciseGrades.introShort':
      'Per-exercise grades (Wood → Platinum): set peak, daily volume and consistency, adjusted to your profile.',
    'recap.exerciseGrades.loading': 'Computing exercise grades…',
    'recap.exerciseGrades.listTitle': 'Ranking',
    'recap.exerciseGrades.withData': 'tracked exercises',
    'recap.exerciseGrades.updating': 'updating…',
    'recap.exerciseGrades.sort': 'Sort',
    'recap.exerciseGrades.sortGrade': 'Best → worst grade',
    'recap.exerciseGrades.sortReps': 'Most → least reps',
    'recap.exerciseGrades.sortMuscle': 'Muscle group',
    'recap.exerciseGrades.sortAlpha': 'Alphabetical',
    'recap.exerciseGrades.levelShort': 'Lvl {{n}}',
    'recap.exerciseGrades.checkedShort': 'checked',
    'recap.exerciseGrades.nextGrade': 'Next: {{grade}}',
    'recap.exerciseGrades.parallelLevel': 'Level {{n}}',
    'recap.exerciseGrades.repEqShort': 'rep eq.',
    'recap.exerciseGrades.parallelRepEq': 'Rep eq. (level)',
    'recap.exerciseGrades.levelGate': 'Required level (grade)',
    'recap.exerciseGrades.voieE': 'Path E — balance {{pct}}%',
    'recap.exerciseGrades.voieEHintStrict':
      'Platinum: {{required}} paths at 100% or balance ≥ {{pct}}% (peak, volume, checks)',
    'recap.exerciseGrades.voieEHint': 'Reach ≥ {{pct}}% on peak, volume and checks (versatility path)',
    'recap.exerciseGrades.voieEPathsFull': 'Complete paths: {{n}} / {{required}}',
    'recap.exerciseGrades.detailMissing': 'Exercise not found.',
    'recap.exerciseGrades.backToList': 'Back to ranking',
    'recap.exerciseGrades.detailTitle': 'Exercise sheet',
    'recap.exerciseGrades.activitySpan': 'From {{from}} to {{to}}',
    'recap.exerciseGrades.parallelLevelLine': 'Level {{n}} · {{eq}} push-up equivalent reps (×{{w}})',
    'recap.exerciseGrades.gradePaths': 'Active paths: {{paths}}',
    'recap.exerciseGrades.levelEvolutionTitle': 'Level progression',
    'recap.exerciseGrades.levelEvolutionLine': 'Level {{cur}} → {{next}} · {{eq}} rep eq.',
    'recap.exerciseGrades.levelRepEqNeeded': '{{n}} more rep eq. for level {{next}}',
    'recap.exerciseGrades.nextGradeTargets': 'Next tier {{grade}}: peak {{peak}} · vol. {{life}} · {{checks}} checks',
    'recap.exerciseGrades.performanceMaxTitle': 'Performance max (challenges)',
    'recap.exerciseGrades.secondsShort': 's',
    'recap.exerciseGrades.repsShort': 'reps',
    'recap.exerciseGrades.performanceMaxHint': 'Synced with Performances / challenges tab',
    'recap.exerciseGrades.pushupSplitTitle': 'Push-up breakdown (total)',
    'recap.exerciseGrades.recordsTitle': 'Personal records',
    'recap.exerciseGrades.recordTop': 'Record',
    'recap.exerciseGrades.statBestDay': 'Best day',
    'recap.exerciseGrades.statBestWeek': 'Best week',
    'recap.exerciseGrades.weekTotalHint': 'Total over 7 days (Mon → Sun)',
    'recap.exerciseGrades.statBestMonth': 'Best month',
    'recap.exerciseGrades.monthTotalHint': 'Total for calendar month',
    'recap.exerciseGrades.statChecks': 'Checked sessions',
    'recap.exerciseGrades.statChecksSub': 'Program + linked challenges',
    'recap.exerciseGrades.statAvgDay': 'Average / active day',
    'recap.exerciseGrades.statAvgDaySub': '{{n}} days with activity',
    'recap.exerciseGrades.statYear': 'In {{year}}',
    'recap.exerciseGrades.statYearChecks': '{{n}} checks',
    'recap.exerciseGrades.statRegularity': 'Regularity (planned days)',
    'recap.exerciseGrades.statRegularitySub': '{{ok}} / {{total}} planned days checked',
    'recap.exerciseGrades.statRegularityNa': 'Active program required for this metric',
    'recap.exerciseGrades.statLifetime': 'Total volume',
    'recap.exerciseGrades.checkHistoryTitle': 'Check history',
    'recap.exerciseGrades.checkHistoryHint':
      'Each row = a checked session or logged challenge. Removing a check recalculates the grade.',
    'recap.exerciseGrades.openCheckInCalendar': 'View this check in calendar',
    'recap.exerciseGrades.openInCalendarShort': 'Calendar',
    'recap.exerciseGrades.badgeBestDay': 'Best day',
    'recap.exerciseGrades.badgePeakSession': 'Best session',
    'recap.exerciseGrades.sourceEndurance': 'Push-up challenges',
    'recap.exerciseGrades.deleteCheck': 'Remove this check',
    'recap.exerciseGrades.deleteCheckTitle': 'Remove this check?',
    'recap.exerciseGrades.deleteCheckBody':
      'This removes the session from grade history. Grade may drop; earned trophies stay recorded.',
    'recap.exerciseGrades.deleteCheckConfirm': 'Remove',
    'recap.exerciseGrades.timelineTitle': 'Grade history',
    'recap.exerciseGrades.timelineNoDate': 'Date not recorded (level already reached)',
    'recap.exerciseGrades.vitalsTitle': 'Physical profile',
    'recap.exerciseGrades.vitalsIntro':
      'Weight, height and age adjust thresholds. Priority: local entry, impedance, profile questionnaire.',
    'recap.exerciseGrades.vitalsSource': 'Current source: {{source}}',
    'recap.exerciseGrades.vitalsSex': 'Sex',
    'recap.exerciseGrades.vitalsSexMissing': 'Sex: profile questionnaire (male default for push-up thresholds)',
    'recap.exerciseGrades.vitalsDefaults': 'complete fields for accurate calculation',
    'recap.exerciseGrades.weight': 'Weight (kg)',
    'recap.exerciseGrades.height': 'Height (cm)',
    'recap.exerciseGrades.age': 'Age',
    'recap.exerciseGrades.vitalsSave': 'Save for grades',
    'recap.exerciseGrades.ladderGalleryTitle': 'Exercise grade journey',
    'recap.exerciseGrades.ladderGalleryIntro':
      'Each material has three tiers. Tap for details and your exercises per tier.',
    'recap.exerciseGrades.ladderPalierShort': 'Tier {{n}}',
    'recap.exerciseGrades.ladderTierReached': 'Tier reached: {{label}}',
    'recap.exerciseGrades.ladderDetailBack': 'Back to exercise grade journey',
    'recap.exerciseGrades.ladderDetailStatus': 'Exercise grades',
    'recap.exerciseGrades.ladderDetailHint':
      'Indicative thresholds per tier — your profile (age, sex, weight) may adjust them.',
    'recap.exerciseGrades.ladderDetailTiersTitle': 'Tiers (indicative thresholds)',
    'recap.exerciseGrades.ladderGateShort': 'peak {{p}} · vol. {{v}} · {{c}} checks',
    'recap.exerciseGrades.ladderRecapTitle': 'Recap — your exercises by tier',
    'recap.exerciseGrades.ladderRecapHint': 'Exercises where you reached at least this tier on the sheet.',
    'recap.exerciseGrades.checksShort': 'checks',
    'recap.exerciseGrades.ladderNoExercisesPalier': 'No exercises at this tier yet.',
    'sport.exerciseGrade.progressPeak': 'Peak / max set',
    'sport.exerciseGrade.progressLife': 'Volume',
    'sport.exerciseGrade.progressChecks': 'Checked sessions',
    'recap.grades.meritedLine': '{{grade}} · {{palier}}',
    'recap.grades.meritedSameAsProgression':
    ...
    'recap.assessment.horizonShort': 'Now · what just happened',
    'recap.assessment.horizonMedium': 'Trajectory · what’s taking shape',
    'recap.assessment.horizonLong': 'Journey · since you started',
    ...
    'recap.analyse.cardioLineKm': '{{km}} km · {{n}} run(s) merged.',
    'recap.analyse.cardioLineJump': 'Jump rope: {{n}} jumps in period.',
    'recap.analyse.calJustified': '{{n}} justified day(s) in period.',
    'recap.analyse.calFullDays': '{{n}} day(s) at 100% completion.',
    'recap.analyse.calChallenge': 'Active challenge: {{title}}.',
    'recap.analyse.kpiRunning': 'Running (period)',
    'recap.analyse.kpiStreak': 'Training streak',
    'recap.analyse.kpiStreakBest': 'Best {{n}} d',
    'recap.analyse.kpiChallenges': 'Active challenges',
    'recap.analyse.kpiGtg': 'GTG',
    'recap.analyse.kpiActiveKcal': 'Active kcal',
    'recap.analyse.alerts': 'Attention points',
    'recap.analyse.quizIncomplete': 'Profile questionnaire incomplete — finish it to refine advice.',
    'recap.analyse.pillarCardio': 'Cardio & challenges',
    'recap.analyse.pillarCalendar': 'Calendar & challenges',
    'recap.analyse.noCardioData': 'Little cardio logged in this period.',
    'recap.analyse.noCalendarData': 'Check off sessions to feed the calendar.',
    'recap.analyse.periodHighlights.title': 'Period recap',
    'recap.analyse.periodHighlights.empty': 'Not enough data for this period.',
    'recap.analyse.noWeight': 'Add a weigh-in (Body tracking) to anchor the weight trend.',
    'recap.benchmark.title': 'Benchmarks & comparisons',
    'recap.benchmark.subtitle':
      'Your profile compared with running, street workout and population standards — not just raw numbers.',
    'recap.benchmark.hint':
      'Local estimates from your Momentum data and public sport benchmarks. Click a card for detail.',
    'recap.programCoach.signalsExtra': 'Detailed program signals',
    'recap.enrichment.pushPull': 'Push / Pull (reps)',
    'recap.enrichment.adherenceItems': 'Item adherence',
    'recap.enrichment.weightDelta': 'Weight change',
    'recap.enrichment.weightLatest': 'Latest: {{v}} kg',
    'recap.enrichment.dowAdherence': 'Completion by weekday',
    'recap.enrichment.muscleShare': 'Muscle share (reps)',
    'recap.enrichment.feedbackAggregate': 'Session feedback (averages)',
    'recap.enrichment.feedbackCount': '{{n}} sessions logged',
    'recap.enrichment.feedback.ressenti': 'Feel',
    'recap.enrichment.feedback.difficulte': 'Difficulty',
    'recap.enrichment.feedback.motivation': 'Motivation',
    'recap.enrichment.feedback.sommeil': 'Sleep (feedback)',

    'recap.programCoach.title': 'Program analysis',
    'recap.programCoach.vision': 'Coach view',
    'recap.programCoach.musclePlan': 'Muscle distribution (weekly plan)',
    'recap.programCoach.pushPullRatio': 'Planned push/pull ratio: {{ratio}}',
    'recap.programCoach.levelStructural': 'Structure & balance',
    'recap.programCoach.levelProgression': 'Actual progression',
    'recap.programCoach.levelRecovery': 'Recovery',
    'recap.programCoach.levelTrends': 'Detected trends',
    'recap.programCoach.levelCompliments': 'Positive points',
    'recap.programCoach.levelRecommendations': 'Recommendations',
    'recap.programCoach.noProgram': 'Activate a program for this analysis.',
    'recap.programCoach.noProgression': 'Check off sessions to compare plan vs actual.',
    'recap.programCoach.noRecovery': 'Connect Garmin or log feedback to enrich.',
    'recap.programCoach.noTrends': 'Not enough cross-data in this period.',
    'recap.programCoach.noCompliments': 'Keep training — compliments come with consistency.',
    'recap.programCoach.noRecommendations': 'Program already well calibrated on current data.',
