...
export const translations = {
  [LANGUAGES.FR]: {
    ...
    'knowledge.subtitle': 'Vidéos, articles et notes — stockées localement sur cet appareil (IndexedDB).',
    'knowledge.breadcrumb': 'Savoir & performance',
    ...
    'knowledge.authRequiredHint': 'Connecte-toi pour consulter la base de connaissances.',
    ...
    'knowledge.storageStats': '{{videos}} vidéo(s) · {{articles}} article(s) · {{notes}} note(s) · {{size}} vidéos',
  ...
  [LANGUAGES.EN]: {
    ...
    'knowledge.subtitle': 'Videos, articles and notes — stored locally on this device (IndexedDB).',
    'knowledge.breadcrumb': 'Knowledge & performance',
    ...
    'knowledge.authRequiredHint': 'Sign in to browse the knowledge base.',
    ...
    'knowledge.storageStats': '{{videos}} video(s) · {{articles}} article(s) · {{notes}} note(s) · {{size}} videos',
