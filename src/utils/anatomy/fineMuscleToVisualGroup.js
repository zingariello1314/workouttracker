...
const EXACT_TO_GROUP = {
  ...
  'brachio-radial': G.FOREARMS,
  'avant-bras': G.FOREARMS,
  avantbras: G.FOREARMS,
  'flechisseurs du poignet': G.FOREARMS,
  'extenseurs du poignet': G.FOREARMS,
  'flechisseurs des doigts': G.FOREARMS,
  'extenseurs des doigts': G.FOREARMS,
  interosseux: G.FOREARMS,
  lombricaux: G.FOREARMS,
  'flechisseurs des doigts et poignet': G.FOREARMS,
  /** Banque étirements : libellé agrégé avant-bras */
  'extenseurs / flechisseurs': G.FOREARMS,
  'extenseurs/flechisseurs': G.FOREARMS,
  'fascia interosseux': G.FOREARMS,
  // Legs
  quadriceps: G.QUADS,
  ...
  /** Flexion de hanche uniquement — pas « fléchisseurs du poignet ». */
  'flechisseurs de hanche': G.QUADS,
  'ischio-jambiers': G.HAMSTRINGS,
  ischiojambiers: G.HAMSTRINGS,
  fessiers: G.GLUTES,
  'fessiers moyens': G.GLUTES,
  'moyen fessier': G.GLUTES,
  mollets: G.CALVES,
  ...
  adducteurs: G.ADDUCTORS,
  'cou': G.NECK,
  nuque: G.NECK,
  cervical: G.NECK,
  scm: G.NECK,
  abducteurs: G.HAMSTRINGS,
  'stabilisateurs de cheville': G.CALVES,
  deltoides: G.SHOULDERS,
  abdominaux: G.CORE,
  obliques: G.CORE,
  'ischio': G.HAMSTRINGS,
  ...
  'sterno-cleido-mastoidien': G.NECK,
  'sterno cleido mastoidien': G.NECK,
  scalenes: G.NECK,
  'scalene': G.NECK,
...
const PATTERN_RULES = [
  ...
  { re: /deltoid|deltoides|epaule|épaule|shoulder|trapeze|trapèze|elevateur|élevateur|scapul/i, group: G.SHOULDERS },
  { re: /triceps/i, group: G.TRICEPS },
  { re: /biceps/i, group: G.BICEPS },
  { re: /brachial(?!is)/i, group: G.BICEPS },
  { re: /brachio[- ]?radial|brachioradialis/i, group: G.FOREARMS },
  {
    re: /avant[- ]?bras|forearm|poignet|wrist|farmer|prise|grip|doigt|interosseux|lombric/i,
    group: G.FOREARMS
  },
  /** Avant quadri / adducteurs : ischio & mollets. */
  { re: /ischio[- ]?jamb|ischium|hamstring|arrière de cuisse/i, group: G.HAMSTRINGS },
  { re: /glute|fessier/i, group: G.GLUTES },
  { re: /mollet|gastroc|soleaire|soléaire|surae|calf/i, group: G.CALVES },
  { re: /adduct/i, group: G.ADDUCTORS },
  { re: /tibial(?!is)|peronier|perrone/i, group: G.TIBIALIS_ANTERIOR },
  { re: /cou|nuque|neck|cervical|splenius|sterno|mastoid|scalene/i, group: G.NECK },
  { re: /quadri|vaste|droit f[eé]moral|femoral|psoas|flechisseurs de hanche/i, group: G.QUADS },
  { re: /abduct/i, group: G.HAMSTRINGS },
  { re: /stabilisateur.*cheville|cheville.*stabil/i, group: G.CALVES },
