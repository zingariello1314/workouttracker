...
export const SEMANTIC_INSIGHT_GROUPS = {
  ...
  composed: ['composed'],
  reading_continuity: ['continuity', 'volume_traj'],
  ...
  reading_journey: ['journey_progress', 'journey_pr_vs_level', 'journey_milestones'],
  reading_plateau: ['journey_plateau'],
  reading_abandoned: ['journey_abandoned'],
  reading_period_density: ['disc_density', 'disc_volume_shape'],
  reading_period_muscle: ['disc_muscle_now', 'disc_muscle_reorient', 'disc_push_pull'],
  reading_period_exercise: ['disc_exercise_share', 'disc_exercise_base', 'disc_emergence', 'disc_composition_not_volume'],
  reading_period_peak: ['disc_peak_day'],
  reading_period_run: ['disc_no_running'],
  reading_period_journey: ['disc_anchor', 'disc_repertoire', 'disc_freq_continuity', 'disc_kcal_profile', 'disc_quarter_profile', 'disc_exercise_progress', 'disc_quarter_arc', 'disc_best_month'],
  reading_period_habit: ['disc_vs_habit', 'disc_comparable'],
  reading_period_pending: ['disc_pending_session', 'disc_pending_context'],
  reading_milestone_first: [
    'disc_ms_first_session',
    'disc_ms_first_exercise',
    'disc_ms_first_run',
    'disc_ms_first_hour',
    'disc_ms_first_load'
  ],
  reading_milestone_return: ['disc_ms_return', 'disc_ms_return_run', 'disc_ms_return_gtg', 'disc_ms_return_durable'],
  reading_milestone_pr: ['disc_ms_pr', 'disc_ms_pr_consolidated', 'disc_ms_pr_density', 'disc_ms_pr_pace', 'disc_ms_pr_load'],
  reading_milestone_threshold: [
    'disc_ms_day_volume',
    'disc_ms_cumul',
    'disc_ms_sessions',
    'disc_ms_km',
  ...
  reading_milestone_weight: ['disc_ms_weight'],
  reading_milestone_goal: ['disc_ms_goal', 'disc_ms_goal_run', 'disc_ms_goal_weight'],
  reading_milestone_combo: ['disc_ms_sleep_combo', 'disc_ms_event_combo'],
  reading_milestone_regime: ['disc_ms_regime'],
  reading_milestone_transform: ['disc_ms_mix_shift'],
  reading_period_sleep: [
    'disc_sleep_context',
    'disc_sleep_night',
    'disc_sleep_assoc',
    'disc_sleep_volume',
  ...
  reading_period_ratio: ['disc_ratio_structure', 'disc_muscle_share_shift'],
  reading_period_stimulus: ['disc_stimulus_mix', 'disc_structural_memory', 'disc_family_fade'],
  reading_period_cardio: ['disc_sleep_cardio', 'disc_cardio_strength'],
