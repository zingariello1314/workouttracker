...
export function buildHorizonEssayCandidates(opts = {}) {
  ...
  if (current.sessions + habit.sessions >= 1) {
    ...
    short(
      'continuity',
      "Tu t'entraînes moins souvent, mais pas moins longtemps quand tu t'y mets",
      [
